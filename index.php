...
<div class="row">
 ...
 <div class="input-group input-group-sm">
  ...
  <input type="text" name="Origin" id="country1" class="form-control" placeholder="Город #1" aria-describedby="sizing-addon3" required>
  ...
  <input type="text" name="Destination" id="country2" class="form-control" placeholder="Город #2" aria-describedby="sizing-addon3" required>
